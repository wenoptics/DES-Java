...
public class SBox {
     ...
     */
    public static BitStructure doSBox(int round_n, BitStructure input) {

        assert input.length() == 6;

        int row = Utils.bin2int(new boolean[] {input.get(0), input.get(5)});
        // the 011110
        int col = input.get(1, 5).getValue();
